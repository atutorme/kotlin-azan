...
fun main() {
    ...
    println("solarNoon: ${sunNOAA2.solarNoon.toTimeString()}")
    println("sunriseTime: ${sunNOAA2.sunriseTime.toTimeString()}")
    println("sunriseTimeAltitudeCorrected: ${sunNOAA2.sunriseTimeAltitudeCorrected.toTimeString()}")
    println("sunsetTime: ${sunNOAA2.sunsetTime.toTimeString()}")
    println("sunsetTimeAltitudeCorrected: ${sunNOAA2.sunsetTimeAltitudeCorrected.toTimeString()}")
